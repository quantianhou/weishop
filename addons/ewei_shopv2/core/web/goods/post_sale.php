...
if ($_W['ispost']) 
{
	...
	show_json(1, array('url' => webUrl('goods', array('id' => $id, 'tab' => str_replace('#tab_', '', $_GPC['tab'])))));
}
if (!(empty($id))) 
{
	if (empty($item)) 
