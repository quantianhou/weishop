...
require_once dirname(__DIR__) . '/alisms/api_sdk/vendor/autoload.php';
...
class AliyunSms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIgB8FLNpb4U6T"; // AccessKeyId

        $accessKeySecret = "qq8coiIK1f9wSYlWoeo6caveshvxyO"; // AccessKeySecret
