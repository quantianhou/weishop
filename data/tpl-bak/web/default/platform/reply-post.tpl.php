		...
		<div class="form-group">
			...
			<div class="form-controls col-sm-8">
				<label>
					...
					<div class="switch" ng-class="{switchOn:reply.status}" id="key-replystatus" ng-click="changeStatus(key-replystatus)"></div>
				</label>
			...
			<div class="form-group">
				<label for="" class="control-label col-sm-2">是否开启</label>
				<div class="form-controls col-sm-8">
					<input id="replyall-1" type="radio" name="replyall" value="1" <?php  if(intval($reply['replyall'] == 1)) { ?> checked="checked"<?php  } ?>/>
					<label for="replyall-1" >开启</label>
					<input id="replyall-2" type="radio" name="replyall" value="2" <?php  if(intval($reply['replyall'] == 2)) { ?> checked="checked"<?php  } ?>/>
					<label for="replyall-2">关闭</label>
					<span class="help-block">开启，则回复内容全部回复,否则是随机一条内容.</span>
				</div>
			</div>
			<!--关闭则添加多条回复内容时, 随机回复其中一条-->
		</div>
		<div class="form-group">
