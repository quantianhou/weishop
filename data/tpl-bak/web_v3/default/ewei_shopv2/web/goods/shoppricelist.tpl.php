            ...
            <div class="modal-body" style="height:270px">
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-xs-12">
                        <label class="radio-inline"><input type="radio"  name="iscover2" value="0" <?php  if($iscover ==0) { ?> checked="checked"<?php  } ?> /> 当前选中商品</label>
                        <label class="radio-inline"><input type="radio"  name="iscover2" value="1" <?php  if($iscover ==1) { ?> checked="checked"<?php  } ?> /> 当前所有商品</label>
