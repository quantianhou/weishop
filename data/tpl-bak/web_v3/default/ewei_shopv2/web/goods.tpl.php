        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo webUrl('goods/change',array('type'=>'productprice','id'=>$item['id']))?>" ><?php  echo $item['productprice'];?></a>
                    <i class="icow icow-weibiaoti-- " data-toggle="ajaxEdit2"></i>
                    <?php  } else { ?>
                    <?php  echo $item['productprice'];?>
                    <?php  } ?><?php  } ?>
