            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php  if($row['is_header']==1) { ?>店长<?php  } else { ?>员工<?php  } ?></td>
                        <td>
                            <a  href="<?php  echo webUrl('commission/agent/user',array('id' => $row['xiajiid']));?>"  style="color:#44abf7" target='_blank' data-toggle='popover' data-placement='right' data-html="true" data-trigger='hover' data-content='查看推广下线'>
                                <?php  echo $row['xiaji'];?>
                            </a>
                        </td>
