        ...
        <div class="tab-pane active">
            ...
            <div class="col-sm-9 col-xs-12">
                ...
                <a href='<?php  echo tomedia($item["thumb"])?>' target='_blank'>
                    <img src="<?php  echo tomedia($item['thumb'])?>" style='height:100px;border:1px solid #ccc;padding:1px;float:left;margin-right:5px;' onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'"/>
                </a>
                <?php  } } ?>
                <?php  } ?>
            </div>
