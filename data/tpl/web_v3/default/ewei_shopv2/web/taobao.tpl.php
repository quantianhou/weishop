...
<div class="page-content">
    <div class='alert alert-danger'>每次添加的商品链接请保持在3个以内. 尽量在服务器空闲时间来操作，会占用大量内存与带宽，在获取过程中，请不要进行任何操作!<br/>由于近期淘宝天猫的对外接口禁用了包括阿里云在内的多个大型服务器供应商IP。此工具为临时解决方案，现阶段只能抓取的有限的参数。<br/>包括1.商品名称2.商品图片3.商品详情4.商品参数（部分商品类型无法获取到参数）</div>
