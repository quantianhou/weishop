					...
					<div class="portable-editor to-left" style="display: block;">     
						<div class="editor-inner">
							...
							<div class="we7-form we7-padding-top">
								...
								<div class="menu-content" <?php  if($_W['account']['level'] == '1') { ?>style="display:none;"<?php  } ?> ng-show="context.activeItem.type == 'view'  && context.activeItem.forceHide == 0">
									<div class="form-group">
								...
								<div class="panel we7-panel" ng-show="context.activeItem.type != 'view' && context.activeItem.type != 'click'  && context.activeItem.forceHide == 0" style="width:100%;">
