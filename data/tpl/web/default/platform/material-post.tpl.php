	...
	<div class="container">
		<div class="penel we7-panel panel-special">
			...
			<div class="panel-body">
				<div class="appmsg-edit-box clearfix">
					<div class="appmsg-preview-area">
						<div class="appmsg-edit-container appmsg-preview-container js-aside" style="height: 780px;">
					...
					<div class="appmsg-input-area">
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#appmsg-edit" aria-controls="appmsg-edit" role="tab" data-toggle="tab" ng-click="changeClass()">图文编辑</a></li>
							<li role="presentation"><a href="#appmsg-link" aria-controls="appmsg-link" role="tab" data-toggle="tab" ng-click="addLink()">跳转链接</a></li>
						</ul>
						<div class="appmsg-input-area-content clearfix">
							<!-- Tab panes -->
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="appmsg-edit">
									<!--标题-->
								...
								<div role="tabpanel" class="tab-pane" id="appmsg-link">
								...
								<div class="appmsg-edit-item gap-left we7-form">
									<div class="form-group">
										...
										<div>
											...
											<image ng-src="{{ materialList[activeIndex].thumb == '' ? './resource/images/nopic-203.png' :  materialList[activeIndex].thumb}}" style="max-height: 200px;"></image>
										</div>
									</div>
									<div class="form-group">
