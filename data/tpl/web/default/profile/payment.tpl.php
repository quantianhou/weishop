...
<div class="js-profile-payment" ng-controller="paymentCtrl" ng-cloak>
	...
	<ul class="we7-page-tab">
		...
		<li>
		<a href="<?php  echo url('profile/common/upload_file')?>">js接口上传文件</a>
		</li>
	</ul>
	<table class="table we7-table table-hover table-form">
		...
		<col width="140px" />
		<tr>
			<th class="text-left" colspan="3">支付参数</th>
		</tr>
		<tr>
			<td >
				货到支付
			...
			<td >
				{{ paysetting.delivery.switch === true ? '开启' : '关闭' }}
			</td>
		...
		<tr>
			...
			<td >
				{{ paysetting.credit.switch === true ? '开启' : '关闭' }}
			</td>
			<td class="text-center">
				<label>
		...
		<tr>
			...
			<td class="text-center">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#zhifubao">修改</a>
			</td>
		</tr>
		<tr>
			<td >
			...
			<td class="text-center">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#weixin">修改</a>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td class="text-center">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#wechat_fa">修改</a>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td class="text-center">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#yinlian">修改</a>
			</td>
		</tr>
		<tr>
			<td >
			...
			<td class="text-center">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#baidu">修改</a>
			</td>
		</tr>
		<tr>
			<td >
			...
			<td class="text-center">
				<a href="javascript:;" class="color-default" data-toggle="modal" data-target="#huikuan">修改</a>
			</td>
		</tr>
	</table>
