...
<body <?php  if(!empty($_W['setting']['copyright']['skin']) && $_W['setting']['copyright']['skin'] == 'black') { ?>onload="resizeView()" class="skin-black" data-skin="black"<?php  } else { ?> data-skin="default"<?php  } ?> class=" <?php  if((!empty($_GPC['m']) && !in_array($_GPC['m'], array('keyword', 'special', 'welcome', 'default', 'userapi', 'service')) || defined('IN_MODULE')) && $_GPC['main-lg']) { ?> main-lg-body <?php  } ?>">
