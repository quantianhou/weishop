			...
			<div class="tab-content ">
				...
				<?php  if($platform=='wxapp') { ?>
					...
					<div class="tab-pane" id="sut_diyurl" style="min-height: 100px;">
						...
						<div class="row" style="margin: 100px 80px;">

							<div class="input-group">

								<input type="text" placeholder="请输入以https://开头的第三方链接 例如：https://www.baidu.com" id="select-diyurl-kw" value="" class="form-control">

								<span class="input-group-addon btn btn-primary select-btn" data-type="diyurl">确认选择</span>

								<nav id="select-diy-url"></nav>

							</div>

							<div class="help-block text-danger">注意：1. 目标链接域名需到<a href="https://mp.weixin.qq.com/" target="_blank" class="text-danger"><b>小程序管理后台</b></a>配置域名白名单 2. 点击链接将跳出小程序与小程序无关</div>
        	...
        	$(function(){
        		...
        		$(".select-btn").click(function(){
					...
					if(type=='diyurl'){
						...
						if(kw.indexOf('https://')<0){

							tip.msgbox.err("请输入以https://开头的第三方链接");

							return;

						}

						$('#select-diy-url').data('href', '/pages/web/index?url=' + encodeURIComponent(kw)).trigger('click');
